...
% Random Path Definitions
% ====================================================================================================
constant.speed_upper = 2; % squares per clock cycle
constant.speed_lower = 0.5; % squares per clock cycle
constant.delay_upper = 120; % squares per clock cycle
constant.delay_lower = 10; % squares per clock cycle
...
for counter = 1:constant.node_no,
	...
	node.xy_coord = [func_gen_random_double(constant.workspace_x,0,0),func_gen_random_double(constant.workspace_y,0,0)];

	% Random Path Structure
	node.xy_source = node.xy_coord;
	node.xy_dest = [0,0];
	node.xy_component = [0,0];
	node.speed = 0;
	node.delay = 0;
